...
<div class="px-4 sm:px-0">
    ...
    <div class="mb-8 text-center mt-8">
        ...
        <div class="flex justify-center gap-2">
            <a href="{{ url('/projects/' . $project->id . '/edit') }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-yellow-600 hover:bg-yellow-700">
                Edit
            </a>
            <a href="{{ url('/projects') }}" class="inline-flex items-center px-4 py-2 border border-white border-opacity-50 rounded-md shadow-sm text-sm font-medium text-white bg-white bg-opacity-20 hover:bg-opacity-30">
                Back to Projects
            </a>
        </div>
    </div>
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <div class="px-4 py-5 sm:px-6 flex justify-between items-center">
            ...
            <a href="{{ url('/tasks/create?project_id=' . $project->id) }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-yellow-600 hover:bg-yellow-700">
                Add Task
            </a>
        </div>
        <div class="border-t border-gray-200">

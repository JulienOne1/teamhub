...
<div class="px-4 sm:px-0">
    ...
    <div class="mb-8 text-center mt-8">
        ...
        <div class="flex justify-center gap-2">
            <a href="{{ url('/tasks/' . $task->id . '/edit') }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-yellow-600 hover:bg-yellow-700">
                Edit
            </a>
            <a href="{{ url('/tasks') }}" class="inline-flex items-center px-4 py-2 border border-white border-opacity-50 rounded-md shadow-sm text-sm font-medium text-white bg-white bg-opacity-20 hover:bg-opacity-30">
                Back to Tasks
            </a>
        </div>
    </div>
            ...
            <dl>
                ...
                <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd class="mt-1 text-sm sm:mt-0 sm:col-span-2">
                        <a href="{{ url('/projects/' . $task->project->id) }}" class="text-blue-600 hover:text-blue-800">
                            {{ $task->project->name }}
                        </a>
                    </dd>
                </div>

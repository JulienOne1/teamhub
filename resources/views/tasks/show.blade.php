    ...
    <div class="mb-8">
        <div class="flex justify-between items-start">
            ...
            <div class="flex gap-2">
                <a href="{{ url('/tasks/' . $task->id . '/edit') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                    Edit
                </a>
                <a href="{{ url('/tasks') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                    Back to Tasks
                </a>
            </div>
        </div>
